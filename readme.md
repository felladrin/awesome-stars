...
- [qontu/ngx-inline-editor](https://github.com/qontu/ngx-inline-editor) - Native UI Inline-editor Angular (4.0+) component
...
- [iobaixas/angular-inflector](https://github.com/iobaixas/angular-inflector) - Angular inflection service.
- [greggigon/my-personal-kanban](https://github.com/greggigon/my-personal-kanban) - This is a one page HTML/JavaScript application for people who would like to use simple and basic Kanban board for their personal stuff
- [bbiHQ/ngSweetAlert2](https://github.com/bbiHQ/ngSweetAlert2) - AngularJS wrapper for SweetAlert2
- [mlegenhausen/grunt-ng-constant](https://github.com/mlegenhausen/grunt-ng-constant) - Plugin for dynamic generation of angular constant and value definition modules.
...
- [rannn505/child-shell](https://github.com/rannn505/child-shell) - Node.js bindings 🔗 for shell
...
- [raphamorim/write-code-every-day](https://github.com/raphamorim/write-code-every-day) - [No longer maintained] :octocat: A project to honor those developers who believed in the challenge.
...
- [onux/jspp](https://github.com/onux/jspp) - JS++, a sound static/dynamic programming language for web development
...
- [theandersonn/comandos-git](https://github.com/theandersonn/comandos-git) - Guia com seleção de comandos para o trabalho com Git e GitHub
...
- [strapi/strapi](https://github.com/strapi/strapi) - 🚀 Strapi is the leading open-source headless CMS. It’s 100% JavaScript, fully customizable and developer-first.
- [lance-gg/sprocketleague](https://github.com/lance-gg/sprocketleague) - Multiplayer Javascript Game written with networked physics using Lance & A-Frame
- [electron/forge](https://github.com/electron/forge) - :electron: A complete tool for building and publishing Electron applications
- [FredrikNoren/ungit](https://github.com/FredrikNoren/ungit) - The easiest way to use git. On any platform. Anywhere.
...
- [jacobparis/gitpodify](https://github.com/jacobparis/gitpodify) - A simple site to generate useful resources for Gitpodification, including "open in gitpod" buttons and sample configuration scripts
...
- [gitpod-io/run-gp](https://github.com/gitpod-io/run-gp) - Run a local workspace using the .gitpod.yml
...
- [mikenikles/gitpod-minimal-custom-dockerfile](https://github.com/mikenikles/gitpod-minimal-custom-dockerfile) - The most lightweight custom Dockerfile for Gitpod
...
- [gitpod-io/community](https://github.com/gitpod-io/community) - Home for all things Gitpod Community 🏡
...
- [csweichel/gitpod-browser-demo](https://github.com/csweichel/gitpod-browser-demo) - Contains the Gitpod configuration to launch a Firefox in Gitpod
...
- [nolanlawson/cjs-to-es6](https://github.com/nolanlawson/cjs-to-es6) - CLI to convert CommonJS to ES6 modules (UNMAINTAINED)
...
- [coollabsio/coolify](https://github.com/coollabsio/coolify) - An open-source & self-hostable Heroku / Netlify alternative.
- [gitpod-io/website](https://github.com/gitpod-io/website) - Gitpod website and documentation
- [kaisermann/svelte-i18n](https://github.com/kaisermann/svelte-i18n) - Internationalization library for Svelte
- [ssleptsov/ninja-keys](https://github.com/ssleptsov/ninja-keys) - Keyboard shortcuts interface for your website. Working with static HTML, Vanilla JS, Vue, React, Svelte.
- [codesandbox/codesandbox-client](https://github.com/codesandbox/codesandbox-client) - An online IDE for rapid web development
